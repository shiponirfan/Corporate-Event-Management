...
const ContactUs = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Contact Us | Corporate Event Management</title>
      </Helmet>
      <Breadcrumbs
        image={image}
        name={"Contact Us"}
      ...
      <div className="bg-corporate-lightColor">
        <div className="container mx-auto grid lg:grid-cols-2 px-6 md:px-8 gap-8 justify-between items-center py-10 lg:py-20 ">
          <div className="">
            <h2 data-aos="fade-right" data-aos-delay="50" className="text-xl md:text-3xl xl:text-4xl my-4 font-bold border-b  pb-3">
              Contact Us
            </h2>
            <p data-aos="fade-right" data-aos-delay="150" className="my-2 xl:text-lg">
            ...
            <h2 data-aos="fade-right" data-aos-delay="200" className="text-xl md:text-3xl xl:text-4xl my-4 font-bold border-b  pb-3">
              We are Here for You
            </h2>
            <p data-aos="fade-right" data-aos-delay="250" className="my-2 xl:text-lg">
            ...
            <h2 data-aos="fade-right" data-aos-delay="300" className="text-xl md:text-3xl xl:text-4xl my-4 font-bold border-b  pb-3">
              Lets Collaborate
            </h2>
            <p data-aos="fade-right" data-aos-delay="350" className="my-2 xl:text-lg">
